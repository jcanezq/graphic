...
export default function ServicesPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onMutate: async (deletedId) => {
      await queryClient.cancelQueries({ queryKey: ['servicios_list'] });
      const previousData = queryClient.getQueryData(['servicios_list', currentPage, debouncedSearch, categoryFilter]);
      queryClient.setQueryData(['servicios_list', currentPage, debouncedSearch, categoryFilter], (old: any) => {
        if (!old) return old;
        return {
          ...old,
    ...
    onError: (err, newTodo, context) => {
      ...
      if (context?.previousData) {
        queryClient.setQueryData(['servicios_list', currentPage, debouncedSearch, categoryFilter], context.previousData);
      }
    },
    onSettled: () => {
      queryClient.invalidateQueries({ queryKey: ['servicios_list'] });
    },
    onSuccess: () => {
      ...
      <div className="page-body">
        ...
        {loading ? (
          ...
          <div className="card" style={{ padding: "1.5rem", textAlign: "center" }}>
            ...
            <h3>No pudimos cargar los servicios</h3>
